...
packageJson = {
  ...
  keywords: ['command', 'terminal', 'mudbean', 'vvi'],
  homepage: 'https://npm.lmssee.com/command',
  dependencies,
  bugs: {
    url: 'https://github.com/MrMudBean/command/issues',
    email: 'Mr.MudBean@outlook.com',
  },
  repository: {
    type: 'git',
    url: 'git+https://github.com/MrMudBean/command.git',
  },
  publishConfig: {
    access: 'public',
